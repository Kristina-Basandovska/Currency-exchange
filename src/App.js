...
const API_URL =
  "1https://bank.gov.ua/NBUStatService/v1/statdirectory/exchange?json";
const GITHUB='https://github.com/Kristina-Basandovska'
  ...
  return (
    <div className="container mx-auto flex min-h-screen items-center lg:w-11/12 xl:w-3/4">
      <div
        ...
        className="h-screen hidden w-full rounded-l-lg bg-gray-400 bg-cover lg:block lg:w-5/12"
      ></div>

      <div className="w-full rounded-lg bg-white p-5 lg:w-7/12 lg:rounded-l-none mb-10 h-full  shadow-md flex-grow">
        <Header list={headers} />
        <hr class="mb-6 border-t" />
        <div className="rounded-lg border   p-4 shadow-md border-gray-700 space-y-6 bg-gray-800 sm:p-6 lg:p-8">
          <h3 class="text-xl font-medium text-white">Currency Converter</h3>
          <Select
